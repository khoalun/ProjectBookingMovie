        ...
        <div className="container flex justify-between h-16 mx-auto">
          ...
          >
            <svg
              ...
              fill="currentColor"
              viewBox="0 0 32 32"
              className="w-8 h-8 dark:text-emerald-400"
            >
          ...
          <ul className="items-stretch hidden space-x-3 lg:flex">
            <li className="flex">
              <a
                rel="noopener noreferrer"
                href="#"
                className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-emerald-400 dark:border-emerald-400"
              >
                Link
              </a>
            </li>
